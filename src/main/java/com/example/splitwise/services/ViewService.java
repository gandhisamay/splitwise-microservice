...
public class ViewService {
    ...
    public List<ViewMoneyBalanceResponse> getUserActivity(int userId) {
        //respond now
        //select mb.payer.userId, mb.payer.name, mb.receiver.userId, mb.receiver.name, mb.group.groupId, mb.amount from SplitMoneyBalance mb where mb.moneyBalanceId.payerId = ?1 or mb.moneyBalanceId.receiverId = ?1
